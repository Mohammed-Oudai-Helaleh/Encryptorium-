...
class _TripleDesEncryptPageState extends State<TripleDesEncryptPage> {
  ...
  Future<void> _encrypt() async {
    ...
    if (kIsWeb) {
      debugPrint('🔐 [3DES] _encrypt() STARTED');
      debugPrint('🔐 [3DES] isFileMode: ${_selectedFile != null || _selectedFileBytes != null}');
    }
    ...
    // 2️⃣ Create cipher request (3 keys for Triple DES)
    ...
    final result = await processCipherInBackground(
      ...
      subtitle: isFileMode
          ...
          : 'Securing plaintext with Triple DES...',
      request: request,
    );
